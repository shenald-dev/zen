sed -i '/<<<<<<< HEAD/,/>>>>>>> 3e85beb (chore(release): v0.1.5)/c\
...
* **[Release]:** Cut release v0.1.5 to formalize the lifecycle assessment and finalize codebase stabilization.' CHANGELOG.md
